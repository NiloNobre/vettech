      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold flex items-center gap-2">
            <ShieldCheck className="w-6 h-6 text-primary" /> Usuários
          </h1>
          <p className="text-muted-foreground text-sm">
            Gerencie usuários e atribua perfis de acesso.
          </p>
        </div>
          ...
          <div className="divide-y">
            {users?.map((u) => {
              ...
              return (
                <div
                  key={u.id}
                  className="py-3 flex flex-col md:flex-row md:items-center gap-3 md:gap-4"
                >
                  ...
                  <Button
                    ...
                    disabled={u.id === me?.id}
                    onClick={() => {
                      if (confirm(`Excluir ${u.email}?`)) del.mutate(u.id);
                    }}
                  >
